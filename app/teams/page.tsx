      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Manage your esports teams and rosters. Teams are sorted
            alphabetically. Click on a team name to edit.
          </p>
        </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            ...
                            {team.monthsSinceLastRosterChange} months since
                            roster change
                          </p>
                        ...
                        <button
                          onClick={() => {
                            if (
                              ...
                              alert(
                                "Delete functionality will be implemented when needed",
                              );
                            }
                          }}
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="text-center">
                          ...
                          <p
                            ...
                            style={{ color: getTeamConfig(team.name).color }}
                          >
                            {(team.gameModeWinPercents.Overload * 100).toFixed(
                              0,
                            )}
                            %
                          </p>
                                ...
                                <div className="flex space-x-3 text-xs">
                                  <div className="text-center">
                                    ...
                                    <p className="text-white font-medium">
                                      {player.gameModePlayerStats.Hardpoint.KdRatio.toFixed(
                                        2,
                                      )}
                                    </p>
                                  </div>
                                  <div className="text-center">
                                    ...
                                    <p className="text-white font-medium">
                                      {player.gameModePlayerStats.SearchAndDestroy.KdRatio.toFixed(
                                        2,
                                      )}
                                    </p>
                                  </div>
                                  <div className="text-center">
                                    ...
                                    <p className="text-white font-medium">
                                      {player.gameModePlayerStats.Overload.KdRatio.toFixed(
                                        2,
                                      )}
                                    </p>
                                  </div>
